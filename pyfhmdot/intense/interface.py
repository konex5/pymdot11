...
from pyfhmdot.intense.contract import contract_dmps_mpo_dmps_left_border as _contract_left_border_big
from pyfhmdot.intense.contract import contract_dmps_mpo_dmps_right_border as _contract_right_border_big
...
from pyfhmdot.intense.contract import contract_left_right_bloc as _contract_left_right_big

from pyfhmdot.intense.contract import contract_dmps_mpo_mpo_dmps_left_border as _contract_left_border_very_big
from pyfhmdot.intense.contract import contract_dmps_mpo_mpo_dmps_right_border as _contract_right_border_very_big
from pyfhmdot.intense.contract import contract_left_very_big_bloc_dmps as _contract_left_very_big
from pyfhmdot.intense.contract import contract_right_very_big_bloc_dmps as _contract_right_very_big
from pyfhmdot.intense.contract import contract_left_right_very_big_bloc as _contract_left_right_very_big
...
def measure_dmps_mpo_mpo_dmps(dmps_one,mpo_one,mpo_two,dmps_two, position=-1):
    ...
    tmp_left = {}
    _contract_left_border_very_big(tmp_left, dmps_one[0], mpo_one[0], mpo_two[0], dmps_two[0])
    for l in range(1, position, 1):
        tmp = _copy(tmp_left)  # swap
        tmp_left.clear()
        _contract_left_very_big(tmp_left, tmp, dmps_one[l], mpo_one[l], mpo_two[l], dmps_two[l])

    tmp_right = {}
    _contract_right_border_very_big(tmp_right, dmps_one[0], mpo_one[0], mpo_two[0], dmps_two[0])
    for l in range(len(dmps_one)-2, position, -1):
        tmp = _copy(tmp_right)  # swap
        tmp_right.clear()
        _contract_right_very_big(tmp_right, tmp, dmps_one[l], mpo_one[l], mpo_two[l], dmps_two[l])
