...
from pymdot.routine.svd_routine import (
    normalize_the_array,
    truncation_strategy,
    svd_nondeg,
    svd_deg,
)
from pymdot.routine.indices import (
...
from pymdot.routine.mul_routine import (
    mul_mm_blocs_new,
    mul_mm_blocs_snd,
...
def mm_to_theta_with_gate_to_delete_at_some_point(
    ...
    *,
    ...
    from pymdot.intense.mul_mp import multiply_mp
