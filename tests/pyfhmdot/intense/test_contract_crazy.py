...
def test_contract_left():
    ...
    from pyfhmdot.intense.contract import contract_dmps_mpo_dmps_left_border, contract_left_bloc_dmps
...
def test_contract_right():
    from pyfhmdot.models.pymodels import hamiltonian_obc
    from pyfhmdot.intense.contract import contract_dmps_mpo_dmps_right_border, contract_right_bloc_dmps
    mpo = hamiltonian_obc("sh_xxz-hz_u1", {"Jxy": 0, "Jz": 0, "hz": 10}, 3)
    mps_down_left = mpo[-1]
    mps_up_left = mpo[-1]
    mpo_left = mpo[-1]
