...
def create_gate():
    ...
    return create_hamiltonian_gates("sh_xxz-hz_u1",{"Jxy":0.25,"Jz":0.25, "hz":0},3,dbeta=0.0125,is_dgate=True,in_group=True)[0][1]
...
with open("/tmp/pyfhmdot_benchmark_apply_gate.txt", "w") as f:
    ...
    for N in datalist:
        ...
        #
        apply_gate_on_mm_at(mp,th,1,{"dw_one_serie":0},N,True,10**-62,is_um=None,conserve_left_right_after_gate=False,direction_right=-1)
        #
        time_end = time.time()
