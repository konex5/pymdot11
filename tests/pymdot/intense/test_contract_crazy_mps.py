...
def contract_left(make_single_blocs_mps, lhs_indices, lhs_chi_shapes):
    ...
    from pymdot.intense.contract import contract_mps_mpo_mps_left_border
...
def contract_right(make_single_blocs_mps, rhs_indices, rhs_chi_shapes):
    ...
    from pymdot.intense.contract import contract_mps_mpo_mps_right_border
...
def test_contract(
    ...
    left = contract_left(make_single_blocs_mps, lhs_indices, lhs_chi_shapes)
    right = contract_right(make_single_blocs_mps, rhs_indices, rhs_chi_shapes)
    from pymdot.models.pymodels import hamiltonian_obc
...
def contract_mps_left(make_single_blocs_mps, lhs_indices, lhs_chi_shapes):
    mps_down = make_single_blocs_mps(lhs_indices, lhs_chi_shapes, d=1)
    mps_up = make_single_blocs_mps(lhs_indices, lhs_chi_shapes, d=1)

    from pymdot.intense.contract import contract_mps_mps_left_border
...
def contract_mps_right(make_single_blocs_mps, rhs_indices, rhs_chi_shapes):
    mps_down = make_single_blocs_mps(rhs_indices, rhs_chi_shapes, d=1)
    mps_up = make_single_blocs_mps(rhs_indices, rhs_chi_shapes, d=1)

    from pymdot.intense.contract import contract_mps_mps_right_border
...
def test_contract(
    ...
    left = contract_mps_left(make_single_blocs_mps, lhs_indices, lhs_chi_shapes)
    right = contract_mps_right(make_single_blocs_mps, rhs_indices, rhs_chi_shapes)
    from pymdot.intense.contract import contract_left_right_small_bloc
