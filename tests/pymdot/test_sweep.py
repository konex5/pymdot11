...
def test_sweeps():
    from pymdot.simulation import sweep
...
def test_print_single():
    from pymdot.simulation import print_single, print_double
...
def test_sweep_move(size):
    from pymdot.simulation import sweep_move
...
def test_modulo_odd_bonds_should_apply():
    from pymdot.simulation import should_apply
